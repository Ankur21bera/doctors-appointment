  ...
  return docInfo && (
    <div>
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          <img className='bg-blue-700 w-full sm:max-w-72 rounded-lg' src={docInfo.image} alt="" />
        </div>
      ...
      <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
        ...
        <div className='flex gap-3 items-center w-full overflow-x-scroll lg:overflow-hidden mt-4'>
          {
        ...
        <div className='flex items-center gap-3 w-full mt-4 overflow-x-scroll sm:overflow-x-scroll sm:mt-1 lg:overflow-hidden'>
